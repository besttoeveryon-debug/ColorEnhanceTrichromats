...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--gan_mode', type=str, default='lsgan', help='the type of GAN objective. [vanilla| lsgan | wgangp | Multi-scale Perceptual Loss]. vanilla GAN loss is the cross-entropy objective used in the original GAN paper.')
